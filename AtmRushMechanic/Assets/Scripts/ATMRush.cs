...
public class ATMRush : MonoBehaviour
{
    ...
    public void StackCube(GameObject other, int index)
    {
        ...
        StartCoroutine(ObjectsGettinBigger());
    }

    private IEnumerator ObjectsGettinBigger()
    {
    ...
    private void MoveListElements()
    {
        for (int i = 1; i < cubes.Count; i++)
        {
            ...
            cubes[i].transform.DOLocalMove(pos, movementDelay); //delay süresine göre positionları değişecek
    ...
    private void MoveOrigin()
    {
        for (int i = 1; i < cubes.Count; i++)
        {
            ...
            cubes[i].transform.DOLocalMove(pos, 0.70f); //delay süresine göre positionları değişecek
